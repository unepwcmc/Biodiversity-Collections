...
INSERT INTO network ( id, board_members, description, name, status ) VALUES (4, 'Julio Helden', 'Lorem ipsum dolor sit amet, essent percipitur at mea, vim ea partem eruditi mandamus, sint dolore nam ex. Sit et nonumes vulputate sententiae. Mutat movet ocurreret an sit, at sonet definiebas quo, est ne menandri molestiae. No sed suas veritus necessitatibus, vix suas case semper ut, quod omittam explicari ei eum. Vix quando minimum in, cu vide copiosae constituto his.', 'Network ipsum dolor sit amet', true);
INSERT INTO network ( id, board_members, description, name, status ) VALUES (5, 'Samuel Castro', 'Euismod laboramus neglegentur ea eum. Ut mei aperiam dolores sadipscing. Mel possim detracto ocurreret ei, malis saepe euripidis ea mea, cu nec fierent temporibus. Pro at amet erant, sit ut vidisse saperet, eum etiam ponderum ne. Mazim atomorum mediocrem ei eos.', 'Network laboramus neglegentur ea eum', true);
INSERT INTO network ( id, board_members, description, name, status ) VALUES (6, 'Alexandre Barbosa', 'Pri ea principes expetendis repudiandae. Ut cum lorem novum delicata. Ius eu quis nostrum intellegam, dolore eirmod mel at, modo commune cu duo. Eu oratio saperet mel, facilis quaestio ius ex.','Network ea principes expetendis repudiandae', true);
INSERT INTO network ( id, board_members, description, name, status ) VALUES (7, 'Antonio Brauna', 'Lorem ipsum dolor sit amet, essent percipitur at mea, vim ea partem eruditi mandamus, sint dolore nam ex. Sit et nonumes vulputate sententiae. Mutat movet ocurreret an sit, at sonet definiebas quo, est ne menandri molestiae. No sed suas veritus necessitatibus, vix suas case semper ut, quod omittam explicari ei eum. Vix quando minimum in, cu vide copiosae constituto his.', 'Network ipsum dolor sit amet', true);
INSERT INTO network ( id, board_members, description, name, status ) VALUES (8, 'Zé Brauna', 'Euismod laboramus neglegentur ea eum. Ut mei aperiam dolores sadipscing. Mel possim detracto ocurreret ei, malis saepe euripidis ea mea, cu nec fierent temporibus. Pro at amet erant, sit ut vidisse saperet, eum etiam ponderum ne. Mazim atomorum mediocrem ei eos.', 'Network laboramus neglegentur ea eum', true);
INSERT INTO network ( id, board_members, description, name, status ) VALUES (9, 'Carlos Magno', 'Pri ea principes expetendis repudiandae. Ut cum lorem novum delicata. Ius eu quis nostrum intellegam, dolore eirmod mel at, modo commune cu duo. Eu oratio saperet mel, facilis quaestio ius ex.','Network ea principes expetendis repudiandae', true);
INSERT INTO network ( id, board_members, description, name, status ) VALUES (10, 'Elione Magalhões', 'Lorem ipsum dolor sit amet, essent percipitur at mea, vim ea partem eruditi mandamus, sint dolore nam ex. Sit et nonumes vulputate sententiae. Mutat movet ocurreret an sit, at sonet definiebas quo, est ne menandri molestiae. No sed suas veritus necessitatibus, vix suas case semper ut, quod omittam explicari ei eum. Vix quando minimum in, cu vide copiosae constituto his.', 'Network ipsum dolor sit amet', true);
INSERT INTO network ( id, board_members, description, name, status ) VALUES (11, 'Chico Mendes', 'Euismod laboramus neglegentur ea eum. Ut mei aperiam dolores sadipscing. Mel possim detracto ocurreret ei, malis saepe euripidis ea mea, cu nec fierent temporibus. Pro at amet erant, sit ut vidisse saperet, eum etiam ponderum ne. Mazim atomorum mediocrem ei eos.', 'Network laboramus neglegentur ea eum', true);
INSERT INTO network ( id, board_members, description, name, status ) VALUES (12, 'Marcos Paulo', 'Pri ea principes expetendis repudiandae. Ut cum lorem novum delicata. Ius eu quis nostrum intellegam, dolore eirmod mel at, modo commune cu duo. Eu oratio saperet mel, facilis quaestio ius ex.','Network ea principes expetendis repudiandae', true);
...
INSERT INTO users (id, first_name, institution_id, email, username, enabled, password, user_role_id) VALUES (4,'Maria Souza', 1,'marias@email.com','marias@email.com', TRUE, '123456', 2);
INSERT INTO users (id, first_name, institution_id, email, username, enabled, password, user_role_id) VALUES (5,'Rogério Henriques', 2,'rogerioh@email.com','rogerioh@email.com', TRUE, '123456', 2);
INSERT INTO users (id, first_name, institution_id, email, username, enabled, password, user_role_id) VALUES (6,'Cássio da Silva', 2,'cassios@email.com','cassios@email.com', TRUE, '123456', 2);
INSERT INTO users (id, first_name, institution_id, email, username, enabled, password, user_role_id) VALUES (7,'Augusto Couto', 2,'augustoc@email.com', 'augustoc@email.com', TRUE, '123456', 2);
INSERT INTO users (id, first_name, institution_id, email, username, enabled, password, user_role_id) VALUES (8,'Wladimir Pereira', 3,'wladmirb@email.com', 'wladmirb@email.com',TRUE, '123456', 2);
INSERT INTO users (id, first_name, institution_id, email, username, enabled, password, user_role_id) VALUES (9,'Débora Barbosa', 3,'deborab@email.com','deborab@email.com', TRUE, '123456', 2);
INSERT INTO users (id, first_name, institution_id, email, username, enabled, password, user_role_id) VALUES (10,'Gabriela Antunes', 3,'grabrielaa@email.com','grabrielaa@email.com', TRUE, '123456', 2);
INSERT INTO users (id, first_name, institution_id, email, username, enabled, password, user_role_id) VALUES (11,'Josimar Barbosa', 3,'josimarb@email.com', 'josimarb@email.com',TRUE, '123456', 2);
INSERT INTO users (id, first_name, institution_id, email, username, enabled, password, user_role_id) VALUES (12,'José Linhares', 3,'josel@email.com','josel@email.com', TRUE, '123456', 2);
...
INSERT INTO network_biodiversity_collection (network_id, collection_id) VALUES (4, 1);
INSERT INTO network_biodiversity_collection (network_id, collection_id) VALUES (5, 1);
INSERT INTO network_biodiversity_collection (network_id, collection_id) VALUES (6, 1);
INSERT INTO network_biodiversity_collection (network_id, collection_id) VALUES (7, 1);
INSERT INTO network_biodiversity_collection (network_id, collection_id) VALUES (8, 1);
INSERT INTO network_biodiversity_collection (network_id, collection_id) VALUES (9, 1);
INSERT INTO network_biodiversity_collection (network_id, collection_id) VALUES (10, 1);

-- Documents
INSERT INTO document (id, author, content_type, description, name, status, title, type, sample_id, collection_id)
  VALUES(1, 'Eduardo Alvares', 'pdf', 'No elitr tacimates vim. Eius summo et ius, mel ad cibo aliquip, cu quaestio qualisque iracundia sea. Ad augue saepe vivendo eum, ei vim periculis efficiantur.', 'Ut cum nobis dolor', false, 'Ut cum nobis dolor', 'PUBLICATION', 1, 1);
INSERT INTO document (id, author, content_type, description, name, status, title, type, sample_id, collection_id)
...
INSERT INTO document (id, author, content_type, description, name, status, title, type, sample_id, collection_id)
  ...
  INSERT INTO document (id, author, content_type, description, name, status, title, type, sample_id, collection_id)
  VALUES(6, 'Maria Eduarda', 'pdf', 'No elitr tacimates vim. Eius summo et ius, mel ad cibo aliquip, cu quaestio qualisque iracundia sea. Ad augue saepe vivendo eum, ei vim periculis efficiantur.', 'Ut cum nobis dolor', false, 'Ut cum nobis dolor', 'PUBLICATION', 2, 1);
INSERT INTO document (id, author, content_type, description, name, status, title, type, sample_id, collection_id)
  VALUES(7, 'Juvenal Brauna', 'doc', 'At fugit vivendo signiferumque pri, ne saepe viderer pri. No tollit nostrum lobortis vel, ut primis aliquam prodesset vis. Quo nisl dolore intellegebat ex, honestatis persequeris ne vix, no cum duis dolore', 'Lorem ipsum dolor sit amet, vix ne laudem constituto disputation', false, 'Lorem ipsum dolor sit amet, vix ne laudem constituto disputation', 'PUBLICATION', 2, 1);
INSERT INTO document (id, author, content_type, description, name, status, title, type, sample_id, collection_id)
  VALUES(8, 'Ilário Carneiro', 'text', 'Ad sea error feugait appellantur, ut error tamquam constituam eos, te discere euismod complectitur ius. Usu in putant option maluisset, liber voluptua signiferumque ei nec, sumo deserunt eum te. Qui ea amet laudem', 'Ea porro invidunt moderatius per', false, 'Ea porro invidunt moderatius per', 'OTHER', 2, 1);
INSERT INTO document (id, author, content_type, description, name, status, title, type, sample_id, collection_id)
