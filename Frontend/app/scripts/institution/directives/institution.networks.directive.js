                    ...
                    function($scope, $rootScope, $stateParams, $state, $translate, $http, toastr){
                        ...
                        $scope.networkAutocomplete = function( userInputString, timeoutPromise){
                            if(userInputString == null)
                                return null;
                            return $http.get( $rootScope.getHost() + "networks/search/not/institution/" + $stateParams.id + "/network?name=" + userInputString ,
                                {
                        ...
                        $scope.createNewNetwork = function () {
                            ...
                            $scope.newNetwork.institutions = [ $scope.institution ];
